...
const ReviewItem = () => {
  ...
  const handleReview = (event) => {
    ...
    fetch(`https://kh-organic-food-server.vercel.app/review`, {
      method: "POST",
      headers: {
      ...
      <div className="flex flex-col max-w-xl p-8 shadow-sm rounded-xl lg:p-12 dark:bg-gray-900 dark:text-gray-100">
        <div className="flex flex-col items-center w-full">
          <div className="container flex flex-col w-full max-w-lg p-6 mx-auto divide-y rounded-md divide-gray-700 dark:bg-gray-900 dark:text-gray-100">
            ...
            <div className="p-4 space-y-2 text-sm dark:text-gray-400"></div>
          </div>
        </div>
        <form onSubmit={handleReview}>
          ...
          <div>
            <textarea
              ...
              name="message"
              placeholder="Message..."
              className="p-4 rounded-md text-black resize-none mt-5 "
            ></textarea>
            <br />
            <input
